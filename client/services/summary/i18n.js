...
angular.module('pi.summary').service('SummaryI18n', ['SummaryFormat', 'SummaryI18n_en', function (SummaryFormat, SummaryI18n_en) {
            ...
            var self = {
                ...
                createTranslator: function createTranslator(translations, defaults) {
                    ...
                    return function (key) {
                        ...
                        if (value === null) {
//                            console.log(SummaryFormat.format("Pending translation for: %s", key));
    ...
    this.getDictionary = i18nProvider.getDictionary;
